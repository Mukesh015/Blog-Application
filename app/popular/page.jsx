        ...
        <div className="border-b border-gray-400 mt-3">
          <div key={index}>
            ...
            {item.description.length > 0 ? (
              ...
              <span className="text-gray-400 block font-normal">No description Available</span>
            )}

            <div className="mb-3">
              <button type='button' className="mt-4 inline-flex items-center gap-x-1 text-blue-600 decoration-2 hover:underline font-medium"
